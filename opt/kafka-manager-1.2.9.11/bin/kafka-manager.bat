...
set "APP_CLASSPATH=%APP_LIB_DIR%\kafka-manager.kafka-manager-1.2.9.11.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.11.7.jar;%APP_LIB_DIR%\com.typesafe.play.twirl-api_2.11-1.0.2.jar;%APP_LIB_DIR%\org.apache.commons.commons-lang3-3.1.jar;%APP_LIB_DIR%\com.typesafe.play.play_2.11-2.3.10.jar;%APP_LIB_DIR%\com.typesafe.play.build-link-2.3.10.jar;%APP_LIB_DIR%\com.typesafe.play.play-exceptions-2.3.10.jar;%APP_LIB_DIR%\org.javassist.javassist-3.18.2-GA.jar;%APP_LIB_DIR%\com.typesafe.play.play-iteratees_2.11-2.3.10.jar;%APP_LIB_DIR%\org.scala-stm.scala-stm_2.11-0.7.jar;%APP_LIB_DIR%\com.typesafe.config-1.2.1.jar;%APP_LIB_DIR%\com.typesafe.play.play-json_2.11-2.3.10.jar;%APP_LIB_DIR%\com.typesafe.play.play-functional_2.11-2.3.10.jar;%APP_LIB_DIR%\com.typesafe.play.play-datacommons_2.11-2.3.10.jar;%APP_LIB_DIR%\joda-time.joda-time-2.3.jar;%APP_LIB_DIR%\org.joda.joda-convert-1.6.jar;%APP_LIB_DIR%\com.fasterxml.jackson.core.jackson-annotations-2.3.2.jar;%APP_LIB_DIR%\org.scala-lang.scala-reflect-2.11.1.jar;%APP_LIB_DIR%\io.netty.netty-3.9.9.Final.jar;%APP_LIB_DIR%\com.typesafe.netty.netty-http-pipelining-1.1.2.jar;%APP_LIB_DIR%\org.slf4j.jul-to-slf4j-1.7.6.jar;%APP_LIB_DIR%\org.slf4j.jcl-over-slf4j-1.7.6.jar;%APP_LIB_DIR%\ch.qos.logback.logback-core-1.1.1.jar;%APP_LIB_DIR%\ch.qos.logback.logback-classic-1.1.1.jar;%APP_LIB_DIR%\com.typesafe.akka.akka-actor_2.11-2.3.14.jar;%APP_LIB_DIR%\com.typesafe.akka.akka-slf4j_2.11-2.3.14.jar;%APP_LIB_DIR%\commons-codec.commons-codec-1.9.jar;%APP_LIB_DIR%\xerces.xercesImpl-2.11.0.jar;%APP_LIB_DIR%\xml-apis.xml-apis-1.4.01.jar;%APP_LIB_DIR%\javax.transaction.jta-1.1.jar;%APP_LIB_DIR%\com.google.code.findbugs.jsr305-2.0.1.jar;%APP_LIB_DIR%\org.webjars.webjars-play_2.11-2.3.0-2.jar;%APP_LIB_DIR%\org.webjars.requirejs-2.1.10.jar;%APP_LIB_DIR%\org.webjars.webjars-locator-0.19.jar;%APP_LIB_DIR%\org.slf4j.slf4j-api-1.7.7.jar;%APP_LIB_DIR%\com.fasterxml.jackson.core.jackson-databind-2.3.3.jar;%APP_LIB_DIR%\com.fasterxml.jackson.core.jackson-core-2.3.3.jar;%APP_LIB_DIR%\org.webjars.bootstrap-3.3.4.jar;%APP_LIB_DIR%\org.webjars.jquery-2.1.4.jar;%APP_LIB_DIR%\org.webjars.backbonejs-1.1.2-4.jar;%APP_LIB_DIR%\org.webjars.underscorejs-1.8.3.jar;%APP_LIB_DIR%\org.webjars.dustjs-linkedin-2.6.1.jar;%APP_LIB_DIR%\org.webjars.json-20121008.jar;%APP_LIB_DIR%\org.apache.curator.curator-framework-2.7.1.jar;%APP_LIB_DIR%\org.apache.curator.curator-client-2.7.1.jar;%APP_LIB_DIR%\org.apache.zookeeper.zookeeper-3.4.6.jar;%APP_LIB_DIR%\jline.jline-0.9.94.jar;%APP_LIB_DIR%\com.google.guava.guava-16.0.1.jar;%APP_LIB_DIR%\org.apache.curator.curator-recipes-2.7.1.jar;%APP_LIB_DIR%\org.json4s.json4s-jackson_2.11-3.2.11.jar;%APP_LIB_DIR%\org.json4s.json4s-core_2.11-3.2.11.jar;%APP_LIB_DIR%\org.json4s.json4s-ast_2.11-3.2.11.jar;%APP_LIB_DIR%\com.thoughtworks.paranamer.paranamer-2.6.jar;%APP_LIB_DIR%\org.scala-lang.scalap-2.11.0.jar;%APP_LIB_DIR%\org.scala-lang.scala-compiler-2.11.0.jar;%APP_LIB_DIR%\org.json4s.json4s-scalaz_2.11-3.2.11.jar;%APP_LIB_DIR%\org.scalaz.scalaz-core_2.11-7.0.6.jar;%APP_LIB_DIR%\org.slf4j.log4j-over-slf4j-1.7.7.jar;%APP_LIB_DIR%\com.adrianhurt.play-bootstrap3_2.11-0.4.jar;%APP_LIB_DIR%\org.apache.kafka.kafka_2.11-0.8.2.1.jar;%APP_LIB_DIR%\org.scala-lang.modules.scala-xml_2.11-1.0.2.jar;%APP_LIB_DIR%\com.yammer.metrics.metrics-core-2.1.2.jar;%APP_LIB_DIR%\net.sf.jopt-simple.jopt-simple-3.2.jar;%APP_LIB_DIR%\org.scala-lang.modules.scala-parser-combinators_2.11-1.0.2.jar;%APP_LIB_DIR%\com.101tec.zkclient-0.3.jar;%APP_LIB_DIR%\org.apache.kafka.kafka-clients-0.8.2.1.jar;%APP_LIB_DIR%\net.jpountz.lz4.lz4-1.2.0.jar;%APP_LIB_DIR%\org.xerial.snappy.snappy-java-1.1.1.6.jar;%APP_LIB_DIR%\kafka-manager.kafka-manager-1.2.9.11-assets.jar"
